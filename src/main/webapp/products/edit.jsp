...
<header class="header">
  ...
  <div class="center"><h1>Quản Lý Sản Phẩm</h1></div>
</header>

<div class="container">
  <main class="main">
    <fieldset>
      <legend>Chỉnh sửa: ${product.name}</legend>
      ...
      <form action="products?action=edit" method="post">
        ...
        <div class="book-detail-container" style="align-items: flex-start;">
          ...
          <div class="img-container">
            <img src="${product.image}" id="previewImg" alt="Preview">
            <div class="edit-form-group" style="margin-top: 15px;">
              <label>Link ảnh (URL):</label>
              <input type="text" name="image" value="${product.image}" onchange="document.getElementById('previewImg').src=this.value">
            </div>
          </div>
          ...
          <div class="details" style="flex: 2;">
            ...
            <div class="edit-form-group">
              ...
              <input type="text" name="alink" value="${product.alink}">
            </div>
            ...
            <div class="edit-form-group">
              ...
              <div class="category-checkbox-list">
                <c:forEach var="cat" items="${categories}">
                  ...
                  <c:forEach var="pCat" items="${product.categories}">
                    <c:if test="${pCat.id == cat.id}">
                      <c:set var="isChecked" value="true" />
                    </c:if>
                  </c:forEach>
                  <label style="font-weight: normal;">
                    <input type="checkbox" name="categoryIds" value="${cat.id}" ${isChecked ? 'checked' : ''}>
                      ${cat.name}
                  </label>
                </c:forEach>
              </div>
          ...
          <div class="summary-box" style="flex: 0 0 100%;">
            ...
            <textarea name="summary" rows="8" style="width: 100%; border: 1px solid #ddd; border-radius: 5px; padding: 10px;">${product.summary}</textarea>
          </div>
